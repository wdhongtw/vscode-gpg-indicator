export const m = {
    ...
    "passphraseInputPromptTitleWhenSecurelyPassphraseCacheEnabled": "Input the passphrase for the signing key, securely passphrase cache enabled",
    "keyDescriptionWithUsedId": "For the key associated with \"{0}\"",
    "keyUnlockedWithCachedPassphrase": "Key unlocked, and the passphrase is stored SECURELY in the SecretStorage of VSCode.",
    "keyUnlocked": "Key unlocked.",
    "keyUnlockFailed": "Failed to unlock: {0}",
    "noCachedPassphraseForCurrentKey": "There is no cached passphrase for your current key.",
    "cachedPassphraseListForDeletion": "List of keys with stored passphrases, select to delete. This action CANNOT be reverted.",
    ...
    "passphraseClearanceConfirm": "Do you REALLY want to clear ALL your cached passphrase?\nThis action CANNOT be reverted.",
